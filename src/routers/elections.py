...
from shared import db, get_current_user, discord, maybe_get_current_user
...
@router.get("/{election}/voter_status", response_model=VoterStatusModel, dependencies=[Depends(discord.requires_authorization), Depends(election_exists)])
