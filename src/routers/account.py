...
from bot import bot
from shared import discord, get_current_user, requires_registration, registration_allowed, db, get_minecraft_user, webapp_page
...
async def register_user(minecraft_user: Annotated[str, Depends(get_minecraft_user)], user: Annotated[User, Depends(discord.user)], registration: RegistrationModel, background_tasks: BackgroundTasks):
